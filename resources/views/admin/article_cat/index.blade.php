                    ...
                    <div class="box-body">
                        <table id="dt" class="table table-bordered table-striped table-hover">
                            ...
                            <tr align="center">
                                ...
                                <th class="text-center" width="200">@lang('article_cat.add_time')</th>
                            ...
                            @forelse($list as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='{{URL::route('admin.article_cat.edit',['id'=>$item->cat_id])}}' data-toggle='tooltip' data-placement='bottom' title='@lang('basic.edit')' style='padding:0 5px;'><i class='fa fa-edit'></i></a>
                                        <a href='{{URL::route('admin.article_cat.del',['id'=>$item->cat_id])}}' class='text-danger' data-toggle='tooltip' data-placement='bottom' title='@lang('basic.del')' style='padding:0 5px;'><i class='fa fa-remove'></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
